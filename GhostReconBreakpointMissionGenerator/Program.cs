...
while (Convert.ToInt32(input) != 0)
{
    if(Convert.ToInt32(input) == 1)
    {
        ...
        {
            int SpecialOperationsActionRegimentArrayOperation = random.Next(0, 26);
